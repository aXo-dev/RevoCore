...
-- Dumping data for table auth.account: 1 rows
...
INSERT INTO `account` (`id`, `username`, `sha_pass_hash`, `sessionkey`, `v`, `s`, `email`, `joindate`, `last_ip`, `failed_logins`, `locked`, `last_login`, `online`, `expansion`, `mutetime`, `locale`, `os`, `recruiter`) VALUES
	(5, 'TEST', '3D0D99423E31FCC67A6745EC89D70D700344BC76', 'CC0DDE05561C3BB311E5C36AD139A39A85505EAB8E1AD874318BA75163632C64AD64A10BF947091D', '488769BC2F9BE51689773E9C82FBA424E3E2D0D69B4508712B57C8F17A99115B', 'ADCD93CD82321F1F5F0E8DC93AD5782FBD44AFB036A94AA1CC27B4A8507AEB63', NULL, '2012-03-05 08:27:33', '127.0.0.1', 0, 0, '2012-03-05 08:28:13', 0, 2, 0, 0, 'Win', 0);
...
-- Dumping data for table auth.account_access: 1 rows
...
-- Dumping structure for table auth.locales_creature_text
...
-- Dumping data for table auth.locales_creature_text: 0 rows
...
-- Dumping data for table auth.realmcharacters: 1 rows
...
INSERT INTO `realmlist` (`id`, `name`, `address`, `port`, `icon`, `color`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`) VALUES
	(1, 'Revo(lution)', '127.0.0.1', 8085, 0, 0, 1, 0, 0, 12340);
...
-- Dumping data for table auth.uptime: 3 rows
/*!40000 ALTER TABLE `uptime` DISABLE KEYS */;
INSERT INTO `uptime` (`realmid`, `starttime`, `startstring`, `uptime`, `maxplayers`, `revision`) VALUES
	(1, 1330953407, '2012-03-05 08:16:47', 0, 0, 'TrinityCore rev. 0000-00-00 00:00:00 +0000 (Archived) (Win32, Release)'),
	(1, 1330954031, '2012-03-05 08:27:11', 0, 0, 'TrinityCore rev. 0000-00-00 00:00:00 +0000 (Archived) (Win32, Release)'),
	(1, 1330958324, '2012-03-05 09:38:44', 0, 0, 'TrinityCore rev. 0000-00-00 00:00:00 +0000 (Archived) (Win32, Release)');
/*!40000 ALTER TABLE `uptime` ENABLE KEYS */;


-- Dumping structure for table auth.warden_action
...
-- Dumping data for table auth.warden_action: ~0 rows (approximately)
/*!40000 ALTER TABLE `warden_action` DISABLE KEYS */;
/*!40000 ALTER TABLE `warden_action` ENABLE KEYS */;


-- Dumping structure for table auth.warden_checks
...
-- Dumping data for table auth.warden_checks: ~737 rows (approximately)
